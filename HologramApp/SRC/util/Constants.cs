...

{
    public static class Constants
    {
        ...
        {
            public static float EDGE_OFFSET = 0.05f; //meters

            public static float DEFAULT_X_POSITION_MACHINE = 0.0f; //meters
            public static float DEFAULT_Y_POSITION_MACHINE = -0.233f; //meters
            ...
            public static float DEFAULT_Z_POSITION_MACHINE_CONTRAST_PLANE = 3.045f; //meters
            ...
            public static float DEFAULT_X_ROTATION_MACHINE_CONTRAST_PLANE = 0.0f; //degrees
            public static float DEFAULT_Y_ROTATION_MACHINE_CONTRAST_PLANE = 180.0f; //degrees
            public static float DEFAULT_Z_ROTATION_MACHINE_CONTRAST_PLANE = 0.0f; //degrees
            ...
            public static float TAG_MACHINE_DEFAULT_X_SCALE = 0.003f;
            public static float TAG_MACHINE_DEFAULT_Y_SCALE = 0.003f;
            public static float TAG_MACHINE_DEFAULT_Z_SCALE = 0.003f;
