...
public:
	...
	void approximate_polygon(std::vector<cv::Point2d> & _quadrilateral, std::vector<cv::Point> const & _points);
...
private:
	...
	void _classify_extreme_point_pair_vertical_edge(_T1 & _t1, _T1 & _t2, _T1 const & _s1, _T1 const & _s2, _T2 const & c1, _T2 const & c2);
	...
	void _approximate_quadrilateral(std::vector<cv::Point2d> & _quadrilateral, std::vector<cv::Point> & _hull);
